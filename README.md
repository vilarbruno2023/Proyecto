...
Buscamos xampp y descargamos el instalador. Luego de descargar el instalador y xampp, debemos de seleccionar las opciones necesarias para trabajar con un servidor local. Para esto debemos seleccionar las opciones de Apache, MySQL y PHP.

Buscamos Git y en la página de Git lo descargamos, en este caso solo nos interesa Git-Bash pero existen otros Git con sus respectivos usos, en general la configuración de git es establecer el nombre y email de usuario. Esto se logra con los comandos: git config —global user.name “nombre de usuario” y git config —global user.email “email del usuario”.
